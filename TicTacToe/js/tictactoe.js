...
// this function will roll random number twice, one for
...
// determin the correct avatar to paint for the active player
...
// this function changes the active player over to the other player
function avatarPlaced() {
    ...
    // check if there is alread a winner...if there is, then dont continue the game
